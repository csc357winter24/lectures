...
# NOTE: When implemented in a non-object-oriented fashion -- as must be done in
#       languages such as C, which have no objects -- the function must take as
#       argument a list on which to operate:
